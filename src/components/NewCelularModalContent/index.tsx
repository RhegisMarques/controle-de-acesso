...
export const NewCelularModalContent = () => {
  ...
  async function createCelular(e: React.FormEvent<HTMLFormElement>){
  e.preventDefault()
  ...
  return (
    <NewCelularContainer onSubmit={createCelular}>
      ...
      <fieldset>
        ...
        <label>
          <span>Imei1</span>
          <input type="number" required onChange={(e) => setImei1(e.target.value)} value={imei1}/>
        </label>
        <label>
          <span>Imei2</span>
          <input type="number"  onChange={(e) => setImei2(e.target.value)} value={imei2}/>
        </label>
      </fieldset>
